...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let isMenuVisible = true; // 초기 상태: 메뉴 표시
    let isPopupVisible = false; // 초기 상태: 팝업 숨김
    let isDarkMode = false; // 다크모드 초기 상태
    ...
    settingsIcon.addEventListener('click', (event) => {
        ...
        isPopupVisible = !isPopupVisible; // 팝업 상태 토글
        settingsPopup.style.display = isPopupVisible ? 'block' : 'none';
        settingsPopup.setAttribute('aria-hidden', !isPopupVisible);
    });
